...
interface ProfitContributionsProps {
  profit: number;
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 m-8">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Worldcoin Human</CardTitle>
          <svg
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {false
              ...
              : "Please advise this user to verify"}
          </p>
        </CardContent>
      </Card>
      <Card>
...
export default ProfitContributions;
